...
make HB_BUILD_DEBUG=yes HB_QTPATH="/usr/lib/qt6/libexec/" HB_WITH_QT="/usr/include/x86_64-linux-gnu/qt6" $*
sudo make HB_BUILD_DEBUG=yes HB_QTPATH="/usr/lib/qt6/libexec/" HB_WITH_QT="/usr/include/x86_64-linux-gnu/qt6" install 
